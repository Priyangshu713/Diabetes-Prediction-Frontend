...
export default function ProfileMenu() {
  return (
    <div className="absolute right-0 top-full mt-2 w-48 py-2 bg-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
